    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Azart Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Azart Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  azart-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Azart in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AZART, 0.1 AZART, 1 AZART and 10 AZART -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Azart Core is shutting down...") + "<br /><br />" +
