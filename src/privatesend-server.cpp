...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Fonero related functionality
...
/*
    ...
    allow endless transaction that would bloat Fonero and make it unusable. To
