...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Azart related functionality
...
/*
    ...
    allow endless transaction that would bloat Azart and make it unusable. To
