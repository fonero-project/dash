...
#define BOOST_TEST_MODULE Azart Test Suite

#include "test_azart.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_azart_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
