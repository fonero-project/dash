...
#define BOOST_TEST_MODULE Fonero Test Suite

#include "test_fonero.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_fonero_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
