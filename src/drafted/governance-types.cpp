...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AzartNetwork") type = AzartNetwork;
    if(strType == "AzartNetworkVariable") type = AzartNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AzartNetwork) s = "AzartNetwork";
    if(type == AzartNetworkVariable) s = "AzartNetworkVariable";
