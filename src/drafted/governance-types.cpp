...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FoneroNetwork") type = FoneroNetwork;
    if(strType == "FoneroNetworkVariable") type = FoneroNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FoneroNetwork) s = "FoneroNetwork";
    if(type == FoneroNetworkVariable) s = "FoneroNetworkVariable";
