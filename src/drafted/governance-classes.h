 ...
 *
 *   // network
 *   CFoneroNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CFoneroNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FoneroNetwork
// //   -- signature requirements : Key1(User)
// class CFoneroNetworkVariable : public CGovernanceObject
// {
// private:
