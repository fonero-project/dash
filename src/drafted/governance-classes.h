 ...
 *
 *   // network
 *   CAzartNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CAzartNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AzartNetwork
// //   -- signature requirements : Key1(User)
// class CAzartNetworkVariable : public CGovernanceObject
// {
// private:
