...
{
    const char* pszTimestamp = "Azart, from players to players";
    const CScript genesisOutputScript = CScript() << ParseHex("045bf939c9166a319c3818341a85878959e32bee0b30bd6ebb58a4de2e13799f6f243f948297c4d644e18c419a587947083bd7e7ebfabe22b1717937bd1d01cf4b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000001e3e5ebe2ff7cafd"); // 21898

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000000017e2918cd68d3dd569217387ca322c75897d3f9ab24c527bc7bbc"); // 21898
        ...
        vAlertPubKey = ParseHex("04f2fd23a7bc35f19488196aedfe79f47bb3fdcb82f734089a0887083e6721597ebc85f1b99fcb56c97ab24ca0b0ecaeb003cf082e17a700cc40a8497160c03fbc");
        nDefaultPort = 9799;
        nMaxTipAge = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
        nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1526536800, 1449959, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // Azart BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Azart BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Azart BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkPubKey = "04c2db88044770711735b24afe38229d926aa732bd1bed25cb2a0ef5edb02b5f90bd080e822bbf2ea38f62f93c4204f3812cc9f971e0485322e67e89cbe62b0463";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x000009b9903dae4466d48db6c264d711ac554492da34cd0bfa4c0b6d230f29c9"))
            ...
            12769,    // * total number of transactions between genesis and last checkpoint
...
public:
	...
	consensus.nMasternodePaymentsIncreasePeriod = 262537200; 
        ...
        genesis = CreateGenesisBlock(1526536801, 1963196, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        // Testnet Azart BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Azart BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Azart BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1526536802, 452094, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        // Regtest Azart BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Azart BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Azart BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
