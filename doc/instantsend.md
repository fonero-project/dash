...
This mechanism has been integrated into Bitcore-Node-Fonero which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fonero-project/insight-api-fonero#web-socket-api](https://github.com/fonero-project/insight-api-fonero#web-socket-api)
* API: [https://github.com/fonero-project/insight-api-fonero#instantsend-transactions](https://github.com/fonero-project/insight-api-fonero#instantsend-transactions)
...
By default, the Fonero Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fonero Core daemon:
