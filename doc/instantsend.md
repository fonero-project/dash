...
This mechanism has been integrated into Bitcore-Node-Azart which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/azartpay/insight-api-azart#web-socket-api](https://github.com/azartpay/insight-api-azart#web-socket-api)
* API: [https://github.com/azartpay/insight-api-azart#instantsend-transactions](https://github.com/azartpay/insight-api-azart#instantsend-transactions)
...
By default, the Azart Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Azart Core daemon:
