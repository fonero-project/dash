...
Only requiring some minor changes is azart.cpp.
...
Changes to azart.cpp
----------------------
azart.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
