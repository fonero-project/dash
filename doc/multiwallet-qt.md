...
Only requiring some minor changes is fonero.cpp.
...
Changes to fonero.cpp
----------------------
fonero.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
