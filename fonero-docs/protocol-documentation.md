...
This document describes the protocol extensions for all additional functionality build into the Fonero protocol. This doesn't include any of the Bitcoin protocol, which has been left intact in the Fonero project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 50000 FNO
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 50000 FNO unspent output
...
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the fonero treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 50000 FNO for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 50000 FNO for masternode 2
