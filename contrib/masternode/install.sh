...
cd /opt/fonero-core
wget https://github.com/fonero-project/fonero/releases/download/v0.13.0.4/fonero-0.13.0.4-linux.tgz
tar -xvf fonero-0.13.0.4-linux.tgz
rm fonero-0.13.0.4-linux.tgz
mv fonero-0.13.0.4-linux/fonerod ./fonerod
mv fonero-0.13.0.4-linux/fonero-cli ./fonero-cli
mv fonero-0.13.0.4-linux/fonero-tx ./fonero-tx
mv fonero-0.13.0.4-linux/fonero-qt ./fonero-qt
rm -rf fonero-0.13.0.4-linux
